...
KEYWORDS = {
    ...
    'landscape': r'\b(mountain|hill|hillside|valley|river|stream|creek|brook|lake|pond|sea|ocean|coast|coastal|beach|shore|shoreline|island|forest|jungle|desert|field|meadow|cliff|cave|waterfall|volcano|peak|summit|plateau|landscape|scenery|view|panorama|horizon|terrain|wilderness|glacier)\b',
    ...
    'technology': r'\b(computer|laptop|internet|phone|telephone|smartphone|email|software|hardware|website|web page|app|software application|technology|technological|digital|screen|monitor|keyboard|mouse|device|gadget|battery|charger|network|wifi|bluetooth|data|download|upload|program|programming|code|robot|machine|electronic|camera|television|printer|server|password|username|computer file|folder|desktop|document|graphic|alarm)\b',
    'health': r'\b(health|healthy|unhealthy|sick|sickness|illness|disease|doctor|physician|hospital|clinic|medicine|medication|drug|pain|painful|hurt|injury|injured|wound|nurse|patient|treatment|therapy|surgery|surgical operation|symptom|fever|cough|cold|flu|virus|infection|headache|toothache|asthma|vaccine|vaccination|pharmacy|allergy|diagnosis|prescription|checkup|recover|recovery|disabled|disability)\b',
    ...
    'media': r'\b(media|mass communication|newspaper|magazine|journalist|journalism|report|reporting|reporter|documentary|film|movie|cinema|actor|actress|director|broadcast|broadcasting|channel|radio|podcast|interview|headline|article|press|publish|publishing|editor|video clip|film clip|footage|episode|series|show|host|hosting|blog|blogger|influencer|advertisement|advertising|commercial|entertainer|celebrity|fame|famous|vip|graffiti|caption|subtitle)\b',
    ...
    'music': r'\b(music|musical|song|sing|singer|singing|melody|tune|rhythm|musical beat|drumbeat|band|orchestra|choir|chorus|instrument|guitar|piano|violin|drum|drums|trumpet|flute|concert|album|lyrics|composer|compose|conductor|note \(music\)|chord|opera|symphony|wind orchestra|brass band|dj|playlist|rapper|rap music)\b',
    ...
    'grammar': r'\b(verb|noun|adjective|adverb|pronoun|preposition|postposition|grammatical particle|conjunction|definite article|indefinite article|tense|plural|singular|grammatical subject|grammatical object|clause|sentence|grammar|grammatical|syntax|conjugation|declension|suffix|prefix|vowel|consonant)\b',
    'physics': r'\b(physics|energy|force|gravity|velocity|speed|atomic mass|body mass|motion|momentum|electric|electricity|magnet|magnetic|wave|frequency|heat|thermal|pressure|atom|atomic|subatomic particle|radiation|voltage|electric current|electrical current|circuit|friction)\b',
    'chemistry': r'\b(chemistry|chemical|element|compound|reaction|acid|alkaline|base|molecule|molecular|chemical solution|mixture|gas|liquid|solid state|oxygen|hydrogen|carbon|nitrogen|metal|alloy|catalyst)\b',
    'biology': r'\b(biology|biological|cell|cellular|organism|gene|genetic|dna|rna|evolution|evolutionary|ecosystem|bacteria|bacterium|virus|body organ|tissue|photosynthesis|chromosome|habitat|reproduction)\b',
}
